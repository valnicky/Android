package course.examples.listview;
//Disponer un ListView con los nombres de paises de sudamérica. Cuando se seleccione un país mostrar en un TextView ("Large Text")
// la cantidad de habitantes del país seleccionado.
